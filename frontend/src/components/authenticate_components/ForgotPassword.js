...
export default function ForgotPassword() {
    ...
    const handleSubmit = (e) => {
        ...
        setLoading(true);
        axios.post('http://localhost:5000/api/authenticate/forgotpassword', { email })
            .then(res => {
                setLoading(false);
                    ...
                    <div className="text-black">
                        <div className="d-flex justify-content-center align-items-center">
                            <form style={{ width: '23rem' }} onSubmit={handleSubmit}>
                                <h3 className="fw-normal mb-3 pb-3" style={{ letterSpacing: '1px' }}>Forgot Password</h3>
                                ...
                                <div className="form-outline mb-4">
                                    <input
                                        ...
                                        autoComplete="off"
                                        className={`form-control form-control-lg ${!isEmailValid && email ? 'is-invalid' : ''}`}
                                ...
                                <div className="pt-1 mb-4">
                                    <button className="btn btn-success btn-lg btn-block" type="submit" disabled={loading || !isEmailValid}>
